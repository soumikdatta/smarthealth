    ...
    //          let jsonData:string=JSON.stringify(result);
             ...
             //console.log("Stored Data constructor:",myData);
              if(myData)
              {
                ...
                let bookingOldURL = GlobalVars.END_POINT_GET_BOOKING_OLD_DATA + "?patient_id=" + myData.records[0].patient_id;
                console.log(bookingOldURL);
                this.httpClient.get(bookingOldURL).map((res: Response) => res).subscribe(data => {
